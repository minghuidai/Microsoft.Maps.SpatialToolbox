...
(function () {
    ...
    CanvasPushpin = function (location, renderCallback) {
        ...
        pin._renderCanvas = function (setSize) {
            renderCallback(pin, getCanvas(pin._canvasID), setSize);
        };

        pin._setSize = function (width, height) {
            pin.setOptions({ width: width, height: height });
        };
